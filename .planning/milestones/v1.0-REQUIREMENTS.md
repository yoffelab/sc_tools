# Requirements Archive: v1.0 Agent-Native CLI
...
- [x] **MEM-03**: `--dry-run` flag for all data-touching commands — validate inputs, report what would happen, without executing

### Multi-Omic Assembly

- [x] **MOM-01**: Patient/subject metadata join across modalities using validated `subject_id`
- [x] **MOM-02**: MuData assembly from independently processed per-modality AnnData objects
- [x] **MOM-03**: Joint embedding via multi-modal integration method (MOFA+, multiVI, or totalVI)
- [x] **MOM-04**: Cross-modal queries at patient/project level (e.g., "show cell type proportions for patient X across all modalities")
...
| MOM-02 | Phase 8 | Complete |
| MOM-03 | Phase 8 | Complete |
| MOM-04 | Phase 8 | Complete |
