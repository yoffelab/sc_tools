...
| `ingest_load` | `data/{sample_id}/adata.h5ad` | Per-sample AnnData loaded from platform output via `sc_tools.ingest.loaders`. |
...
5. **Integrate full dataset:** Apply the selected method to all samples. Save `results/adata.normalized.p3.h5ad`.
...
| Active checkpoints (p0-p4) | HPC scratch | h5ad | `sftp://brb//athena/.../adata.raw.p1.h5ad` |
| Archived checkpoints | AWS S3 | zarr | `s3://yoffelab-sc/projects/ggo_visium/results/adata.celltyped.p4.zarr` |
