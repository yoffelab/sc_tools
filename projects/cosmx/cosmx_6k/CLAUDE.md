...
```bash
# From repo root:
./scripts/run_container.sh projects/cosmx/cosmx_6k python scripts/<script>.py
snakemake -d projects/cosmx/cosmx_6k -s projects/cosmx/cosmx_6k/Snakefile <target>

# Local conda (no container):
conda activate cosmx_6k
SC_TOOLS_RUNTIME=none snakemake -d projects/cosmx/cosmx_6k -s projects/cosmx/cosmx_6k/Snakefile <target>

# Tests:
pytest projects/cosmx/cosmx_6k/tests/ -v
