...
```bash
# From repo root:
./scripts/run_container.sh projects/cosmx_1k python scripts/<script>.py
snakemake -d projects/cosmx_1k -s projects/cosmx_1k/Snakefile <target>

# Local conda (no container):
conda activate cosmx_1k
SC_TOOLS_RUNTIME=none snakemake -d projects/cosmx_1k -s projects/cosmx_1k/Snakefile <target>
