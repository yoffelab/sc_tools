...
- **Spatial/process:** Macrophage localization (proliferative vs macrophage scores, regression, correlation heatmaps); process colocalization (Pearson, Moran's I, volcano by Normal/Non-Solid/Solid). Outputs under `figures/manuscript/` and `results/process_colocalization/`.
